...
public class DownloadTaskProvider extends DownloadTaskClient {
    public DownloadTaskProvider(AppCompatActivity activity, String EXTRA_MESSAGE, Class next){
    ...
    public Parcelable readCliente(JsonReader reader) throws IOException {
        ...
        reader.endObject();
        return new Fornecedor(id, codigo,nome);
    }
