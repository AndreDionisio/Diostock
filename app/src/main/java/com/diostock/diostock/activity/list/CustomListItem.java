...
import com.diostock.diostock.activity.up.UpItemActivity;
...
public class CustomListItem extends BaseAdapter implements ListAdapter {
    ...
    public CustomListItem(ArrayList<Item> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                new DownloadTask((AppCompatActivity) context,EXTRA_MESSAGE,DisplayMessageActivity.class)
                        .execute("http://104.236.57.74:8080/DIOS/item/apagar/"+position);
        ...
        addBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(UpItemActivity.EXTRA_PARCELABLE, (Parcelable) list.get(position));
