...
import com.diostock.diostock.activity.up.UpStockActivity;
...
public class CustomListStock extends BaseAdapter implements ListAdapter {
    public final static String EXTRA_MESSAGE = "com.diostock.diostock.MESSAGE";
    private ArrayList<Estoque> list = new ArrayList<Estoque>();
    private Context context;



    public CustomListStock(ArrayList<Estoque> list, Context context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                new DownloadTask((AppCompatActivity) context,EXTRA_MESSAGE,DisplayMessageActivity.class)
                        .execute("http://104.236.57.74:8080/DIOS/estoque/apagar/"+position);
        ...
        addBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //do something
                Intent intent = new Intent(context, UpStockActivity.class);
                intent.putExtra(UpStockActivity.EXTRA_PARCELABLE, (Parcelable) list.get(position));
